  ...
  _createClass(Noty, [{
    ...
    value: function close() {
      ...
      Utils.addListener(this.barDom, Utils.animationEndEvents, function () {
        ...
        delete API.Store[_this4.id];
        API.fire(_this4, 'afterClose');

        if (_this4.layoutDom.querySelectorAll('.noty_bar').length == 0 && !_this4.options.container) Utils.remove(_this4.layoutDom);

        API.queueRender(_this4.options.queue);
      });
